...
from opendbc.car.byd.values import (
  ...
  PLATFORM_TANG_DMI,
  PLATFORM_SONG_PLUS_DMI,
  PLATFORM_QIN_PLUS_DMI,
  PLATFORM_YUAN_PLUS_DMI_ATTO3,
)
...
NON_LINEAR_TORQUE_PARAMS = {CAR.BYD_HAN_DM_20: [1.807, 1.674, 0.04], CAR.BYD_HAN_EV_20: [1.807, 1.674, 0.04], CAR.BYD_SONG_PLUS_DMI_21: [1.807, 1.674, 0.04]}
...
class CarInterface(CarInterfaceBase):
  ...
  def torque_from_lateral_accel_siglin(
    self,
    latcontrol_inputs: LatControlInputs,
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    ret.longitudinalTuning.kpBP, ret.longitudinalTuning.kiBP = [[0.0], [0.0]]
