...
#_ar_ox_config = DeviceCameraConfig(CameraConfig(1920, 1080, 2648.0), _ar_ox_fisheye, _ar_ox_fisheye)
_ar_ox_config = DeviceCameraConfig(CameraConfig(1920, 1080, 2200.0), _ar_ox_fisheye, _ar_ox_fisheye)
