...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"AutoTurnControlSpeedFork", PERSISTENT},
    ...
    {"LaneCenterStrength", PERSISTENT},
    {"AutoLaneCenterEnabled", PERSISTENT},
    {"AutoLaneCenterKp", PERSISTENT},
    {"AutoLaneCenterKi", PERSISTENT},
    ...
    {"BydButtonMode", PERSISTENT},
    {"BydButtonByteKey", PERSISTENT},
