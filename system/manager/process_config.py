...
procs = [
  ...
  NativeProcess("sensord_wt", "system/sensord_wt", ["./sensord_wt"], only_onroad,
                enabled=PC and os.environ.get("USE_CH347_IMU", "0") != "1" and os.environ.get("USE_WT_IMU", "0") == "1"),
  #NativeProcess("sensord_can", "system/sensord_can", ["./sensord_can"], only_onroad, enabled=PC),
  PythonProcess("sensord_ch347", "system.sensord_ch347.sensord_ch347", only_onroad, enabled=PC and os.environ.get("USE_CH347_IMU", "0") == "1"),
  PythonProcess("sensord_byd", "system.sensord_byd.sensord_byd", only_onroad,
                enabled=PC and os.environ.get("USE_CH347_IMU", "0") != "1" and os.environ.get("USE_WT_IMU", "0") != "1"),
